<?php
	...
	$fsm_text = array(
		...
		'api-instructions'     => __( 'To obtain your developer\'s ID and keys, please %s, click on the right side menu and open "My Profile".', 'freemius' ),
		'login-to-fs'          => __( 'login to
			Freemius', 'freemius' ),
		#region API Credentials

		'bad-credentials'      => __( 'Seems like one of the credentials is wrong. Please make sure you don\'t omit any characters from the keys.', 'freemius' ),
